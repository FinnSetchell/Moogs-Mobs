...
public class ModBlocksStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlockWithItem((RotatedPillarBlock) ModBlocks.WAXED_EXPOSED_COPPER_DEEPSLATE_PILLAR.get(), new ResourceLocation(MoogsMobs.MODID, "block/deepslate/pillars/exposed_copper_deepslate_pillar_side"),
                new ResourceLocation(MoogsMobs.MODID, "block/deepslate/pillars/exposed_copper_deepslate_pillar_top"));
        axisBlockWithItem((RotatedPillarBlock) ModBlocks.WAXED_WEATHERED_COPPER_DEEPSLATE_PILLAR.get(), new ResourceLocation(MoogsMobs.MODID, "block/deepslate/pillars/weathered_copper_deepslate_pillar_side"),
                new ResourceLocation(MoogsMobs.MODID, "block/deepslate/pillars/weathered_copper_deepslate_pillar_top"));
